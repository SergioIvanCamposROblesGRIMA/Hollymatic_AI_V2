...
from src.utils.dateutils import date_utils
...
class assembly_composite:
    ...
    @staticmethod
    def _day_dir():
        day_dir = os.path.join(config_composite.TEMPORAL_IMAGES_DIR, date_utils.today())
        os.makedirs(day_dir, exist_ok=True)
        return day_dir

    # --------------------------------------------------------------------- #
    #   limpiar ./temporal/images al inicio de cada corrida
    # --------------------------------------------------------------------- #
    @staticmethod
    ...
    # --------------------------------------------------------------------- #
    #  guardar el frame ya clasificado por vista
    # --------------------------------------------------------------------- #
    @staticmethod
