"""
Modelos ORM (SQLAlchemy) usados por el contenedor `app` para registrar los intentos.

Espejo de los del contenedor `scheduler` (ambos códigos son separados). Mapean las
