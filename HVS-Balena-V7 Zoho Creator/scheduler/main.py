...
async def main():
    ...
    scheduler.add_job(night_off, trigger='cron',hour='16', minute='12')
    scheduler.add_job(clean, trigger='cron',hour='16',minute='19')
    # Reporte mensual de KPIs: el día 1 de cada mes a las 06:00 (hora local).
    scheduler.add_job(kpi_report, trigger='cron', day='6', hour='16', minute='14')
